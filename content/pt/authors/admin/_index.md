---
bio: Sou um estudante de graduação em Sistemas de Informação com um forte interesse em automação de testes, engenharia de software e qualidade de produtos e no campo da ciência / análise de dados. Sou curioso e tenho me empenhado em desenvolver e aprimorar meus conhecimentos em programação, automação, testes, ciência/análise de dados, bem como em gestão/administração, e tudo mais relacionado.
education:
  courses:
